      ...
      <div className="flex flex-col gap-4 animate-[divAnimate_.4s_ease_forwards] duration-300">
        ...
        <div className="w-full flex gap-6 justify-center items-center h-max p-2 rounded-2xl">
          {ActiveProList.map((e, index) => {
            return (
              <div
                className="flex flex-col relative gap-2 duration-300 overflow-hidden hover:bg-white/20 hover:scale-110 cursor-pointer items-center justify-center w-40 h-40 p-8 rounded-xl text-white/60 border"
                key={index}
              >
