...
const Navbar = () => {
  ...
  return (
    <>
      <div className=" rounded-b-2xl px-12 py-2 backdrop-blur-md bg-[var(--background)]/10 flex justify-between text-[var(--text)] fixed  top-0 xl:right-40 w-full xl:w-auto xl:left-20 z-30 border-b border-[var(--primary)]/40">
