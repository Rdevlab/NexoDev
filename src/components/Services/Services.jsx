      ...
      <div className="w-full flex flex-col xl:flex-row items-center justify-center gap-8 bg-[var(--background)]">
        {services.map((service) => {
          return (
            <div
              key={service.id}
              className="flex flex-col border-[var(--primary)]/60 bg-[var(--primary)]/20 text-[var(--primary)] shadow-[0_0_110px_-50px_#8c00ff] hover:shadow-[0_0_110px_5px_#8c00ff] duration-300 hover:bg-[var(--primary)]/80 hover:text-[var(--text)] hover:scale-110 cursor-default items-center border p-6 rounded-md"
            >
