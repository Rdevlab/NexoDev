...
const Services = () => {
  ...
  return (
    <div
      id="service"
      className="w-full h-[80vh] flex-col flex items-center justify-center gap-16 bg-[var(--background)]"
    >
      ...
      <div className="w-full flex items-center justify-center gap-8 bg-[var(--background)]">
